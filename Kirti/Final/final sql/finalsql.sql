...
proc_Get_Wishlist 'iconajay9.8@gmail.com'
...
create proc proc_UpdateProduct1(@productid int,@rmail varchar(40),@pprice float,@pquantity int,@pdescrip nvarchar(max))
as 
begin
